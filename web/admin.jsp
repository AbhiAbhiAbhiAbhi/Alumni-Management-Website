...
<html>
    ...
    <body>
        ...
        <div class="post">
            <form class="newpost" action="uploadPostAdmin" method="post" enctype="multipart/form-data">
                <textarea name="textarea" onkeyup="check()"  placeholder="Post something...."></textarea>
                <div class="uploadfun">
                    <lable>Photo: </lable><input type="file" class="custom-upload" onchange="check()" id="photo" name="photo" value="Photo/video" accept="image/*,video/*">
